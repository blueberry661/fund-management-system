...
var fundListM = [
  { code: "002834", num: 0, cost: 0 },
  { code: "013853", num: 0, cost: 0 },
  { code: "015714", num: 0, cost: 0 },
  { code: "011158", num: 0, cost: 0 },
  { code: "012550", num: 0, cost: 0 }
];
var showBadge = 1;
var BadgeContent = 1;
var BadgeType = 1;
...
var getValuationUnit = data => {
  let gsz = isNaN(data.gsz) ? null : parseFloat(data.gsz);
  let nav = isNaN(data.dwjz) ? 0 : parseFloat(data.dwjz);
  if (gsz !== null && gsz > 0) {
    return gsz;
  }
  return nav;
